...
#Fitting Random Forest  Regression on to the trtainig set
...
import pickle as pi
with open('ran_forest_model','wb') as f:
    pi.dump(regressor,f)


with open('ran_forest_model','rb') as fi:
    mp = pi.load(fi) 
...
#Visualising the Random Forest Reression Results(for higher smoother curves)
